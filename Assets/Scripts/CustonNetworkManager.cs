...
public class CustonNetworkManager : NetworkManager {
	...
	public void TurnPlayController(bool t){

		MenuCamera.SetActive (!t);
		PlayerCamera.SetActive (t);
		MovePad.SetActive (t);
		skillPad.SetActive (t);

		GlobalInfo.current.TitleUI.SetActive (!t);
		GlobalInfo.current.GameUI.SetActive (t);
	}
